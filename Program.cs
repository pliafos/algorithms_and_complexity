...
{   
     ...
     string[] FileNames = new string[14]{"car-f-92.stu","car-s-91.stu","ear-f-83.stu","hec-s-92.stu","kfu-s-93.stu"
     ,"lse-f-91.stu","pur-s-93.stu","rye-s-93.stu"
     ,"sta-f-83.stu","toy_e5_s6.stu","tre-s-92.stu"
     ,"uta-s-92.stu","ute-s-92.stu","yor-f-83.stu"};
    ...
    public void init()
    {   
        Console.WriteLine("Select one of the following files : ");
        ...
        Console.WriteLine(FileNames[int.Parse(FileNum)-1]);
        FileOpen("datasets/" + FileNames[int.Parse(FileNum)-1]);
        Lessons.Sort();
